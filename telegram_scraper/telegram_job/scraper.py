...
def reload_scraper_config():
    """Reload configuration from environment variables (called by worker entry point)"""
    ...
    print(f"[CONFIG] Reloaded scraper config: Translation={ENABLE_TRANSLATION}, Image={ENABLE_IMAGE_ANALYSIS}, Audio={ENABLE_AUDIO_TRANSCRIPTION}, Emotion={ENABLE_EMOTION_ANALYSIS}, Label={ENABLE_LABEL_CLASSIFIER}, Geo={ENABLE_GEOLOCATION_EXTRACTION}")
